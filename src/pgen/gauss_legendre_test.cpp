...
void ProblemGenerator::UserProblem(ParameterInput *pin, const bool restart) {
  ...
  spherical_grid_output.open ("./polar_pos.out", std::ios_base::app);
  ...
  spherical_grid_output.open ("./cart_pos.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
  ...
  spherical_grid_output.open ("./one_deriv.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
    spherical_grid_output << one_dtheta.h_view(i) << "\t" << one_dphi.h_view(i) <<  "\n";// << ones_dphi.h_view(i) <<"\n";
  }
  spherical_grid_output.close();

  spherical_grid_output.open ("./sinth_deriv.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
    spherical_grid_output << sinth_dtheta.h_view(i) << "\t" << sinth_dphi.h_view(i) <<  "\n";// << ones_dphi.h_view(i) <<"\n";
  }
  spherical_grid_output.close();

  spherical_grid_output.open ("./sinph_deriv.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
  ...
  spherical_grid_output.open ("./cart_pos_reseted.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
    spherical_grid_output << S->cart_pos.h_view(i,0) << "\t" << S->cart_pos.h_view(i,1) << "\t" << S->cart_pos.h_view(i,2) <<  "\n";// << ones_dphi.h_view(i) <<"\n";
  }
  spherical_grid_output.close();
  ...
  spherical_grid_output.open ("./interp_res.out", std::ios_base::app);
  for (int i=0;i<S->nangles;++i) {
