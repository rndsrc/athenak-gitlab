...
void GaussianInnerX1(int m, CoordData &coord, EOS_Data &eos, DvceArray5D<Real> &ii)
{
  ...
  par_for("hohlraum_ix1", DevExeSpace(),0,(n3-1),0,(n2-1),0,(ng-1),
    KOKKOS_LAMBDA(int k, int j, int i)
    {
      ...
      Real x2v0 = dx2/2.0;  // assumes that grid center is y=0, necessary for on-axis sol
      Real x3v0 = dx3/2.0;  // assumes that grid center is z=0, necessary for on-axis sol
