...
//========================================================================================
//! \file isothermal_srhyd.cpp
//! \brief derived class that implements isothermal EOS in special relativistic hydro
...
IsothermalSRHydro::IsothermalSRHydro(MeshBlockPack *pp, ParameterInput *pin) :
...
void IsothermalSRHydro::ConsToPrim(DvceArray5D<Real> &cons, DvceArray5D<Real> &prim,
...
void IsothermalSRHydro::PrimToCons(const DvceArray5D<Real> &prim, DvceArray5D<Real> &cons,
                              const int il, const int iu, const int jl, const int ju,
                              const int kl, const int ku) {
  int &nhyd  = pmy_pack->phydro->nhydro;
  int &nscal = pmy_pack->phydro->nscalars;
