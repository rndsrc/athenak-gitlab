...
//========================================================================================
//! \file isothermal_srmhd.cpp
//! \brief derived class that implements isothermal EOS in special relativistic mhd
...
void IsothermalSRMHD::ConsToPrim(DvceArray5D<Real> &cons, const DvceFaceFld4D<Real> &b,
...
void IsothermalSRMHD::PrimToCons(const DvceArray5D<Real> &prim, const DvceArray5D<Real> &bcc,
